...
#Bubabu #BubabuGe #BoGcashback #KidsGeorgia #ScreenFreePlay #SmartToy #WeekendDeal #TbilisiKids
...
## HEADLINE / DESCRIPTION VARIANTS (Meta Ads Manager)
...
## STORIES / REELS STICKER COPY (short on-screen text)

For 9:16 placement with sticker hooks:
...
#Bubabu #BubabuGe #BoGкэшбек #ИгрушкаДляДетей #БезЭкрана #УмнаяИгрушка

---

FIRST COMMENT (RU):
❓ Какой ОДИН подарок ваш ребёнок продолжал использовать спустя месяц? 👇

---

## GEORGIAN VERSION (toggle for KA-targeted ad set)
...
#Bubabu #BubabuGe #BoGcashback #ბავშვებისთვის #ეკრანისგარეშე
...
Run all 4 hook variants (H1-H4 from `brief.md`) × 3 language ad sets (KA / RU / EN) = 12 total ad variants.

After 24h ($150 GEL spent):
- Pause bottom 50% by CTR
- Scale top 30% by CPA

Best-case: ROAS > 3× during May 9-10 weekend.
