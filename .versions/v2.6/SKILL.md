...
## ADV MODE — Bubabu Adventures (narrator-led cartoon series — LOCKED 2026-05-24 · v2 R1-R7)
...
**v2 (2026-05-24) revisions** per `agents/premortem/content/20260524_bubabu_adv_ep01/transcript.md`: cloud-tree canon (R3, replaces star-nest above-clouds — anti-heaven-iconography), wing-arc spark mechanic (R4, replaces chest-glow ignition), one churchkhela R5 (single GE marker in EP01 only), SKIN_SYSTEM split (R6, identity-lock + 3×3×3 variant flex + §H seasonal), dual-cut requirement (R7, 75s long master + 25s scroll-cut). Narrator audition gate (R1) + Lyria librosa verification (R2) gate Phase B render.
...
| S7 | EPILOGUE_BEAT — Bubabu on sill, single star above. Narrator closing line. | 18.0-25.0s |
...
- [ ] EPILOGUE_BEAT (R6) present as final 3 sec — Bubabu looking up, single star, motif, closing line
