...
| Gift-bundle ad (Bubabu hero + 1-2 catalog SKUs) | `/bubabu gift [occasion] [age]` — uses P6 pillar, pulls SKUs from `product_catalog.md` |
| Retail-zone tour (non-Bubabu SKU under Smart Gifts umbrella) | `/bubabu zone [zone-name] [sku-id-or-name]` — uses P7 pillar, Bubabu anchors opener + closer |
| Age-gated post (3-6 / 7-12 / 13-17 segment-specific) | `/bubabu age [segment] [occasion]` — uses age ladder + zone map |
