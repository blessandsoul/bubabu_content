...
└── [YYYYMMDD]_pair[NN]_[sku-slug]/                ← one pair = one SKU
    ...
    └── ad/                                         ← odd day N+1
        ...
        ├── video.md        (3 scene-blocks dual SPEC cartoon-style: JOY-HOP REVEAL + THEMATIC PLAY + POSSESSION HOLD — each scene = paired NB2 image SPEC + Veo video SPEC. MERGED former image.md into here 2026-05-30 per `feedback_bubabu_ad_video_md_cartoon_style_dual_spec`)
