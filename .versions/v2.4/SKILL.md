...
| **Episode structure** | HYBRID per ep — ADVENTURE setup + MYSTERY beat + LESSON resolution. ONE of three sparks earns the resolution via WING-ARC TRAIL (R4) — not chest-glow. Cliffhanger-soft end via EPILOGUE_BEAT (R6). |
...
### EPILOGUE_BEAT (recurring 3-sec cosmic callback — every ADV ep) — R6

Last 3 seconds of every episode: Bubabu sits on a windowsill / branch / shelf at dusk or dawn, looking up. A single small star is visible. The wonder motif plays one final time. Narrator delivers the universal closing line.

This is the cosmic callback that lets EP02-N keep the mythology alive WITHOUT importing the full cloud-tree cutaway every episode. Mitten-rescue / lost-shoe / thunder-fear stories stay story-scale; the epilogue carries the canon.
...
| 14 | EPILOGUE_BEAT | R6 universal closing — Bubabu on sill looking up, single small star above fading with morning. Motif plays one final time. Narrator delivers closing line. | — |
