...
**Body length:** ~620 chars (within 500-900 window, tighter than cartoon post since ad-mode is benefit-direct).

---

## BODY (paste into FB post / IG caption / TT caption)

```
This is the first gift Bubabu chose for the children who love to think.

🪵 A small wooden tray, painted by hand with seven warm vegetables and labeled gently in Georgian, made for small hands ages three to six.

🌱 Built for screen-free morning play, simple enough for one child to learn each shape by name, slow enough to last across years.

🎁 The first gift in the Bubabu Smart Gifts collection — available now on BUBABU.GE and at our Tbilisi Mall and Galleria Tbilisi shelves.

#bubabu #bubabusmartgifts #smartgiftsforkids #earlylearning #educationaltoys #woodenpuzzle #screenfreeplay #childhoodwonder
```
...
```
❓ Which Georgian vegetable name would your child learn to say first — გოგრა, კიტრი, or სტაფილო? 👇
```

---

## STRUCTURE AUDIT (per SE§9 + BUBABU §BS)
...
### SLOP_FILTER grep (per `bible/SLOP_FILTER_ENGINE.md` v1.0)

- ✅ No negation-correction («not X, it's Y»).
- ✅ No throat-clearing openers («Here's the thing» / «Let me be clear»).
- ✅ No emphasis crutches («Full stop» / «Let that sink in»).
- ✅ No business jargon («deep dive» / «circle back» / «lean into»).
- ✅ No adverb intensifiers («really» / «just» / «literally» / «actually» / «simply»).
- ✅ No meta-commentary.
