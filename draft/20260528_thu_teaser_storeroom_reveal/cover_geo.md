# Cover - Storeroom Reveal Teaser (Georgian Version)
...
- Active option for this Georgian package.
...
| Layer | Choice | Why |
|-------|--------|-----|
| **L0 paper / BG** | Butter-cream gradient `#FFFAEB → #FFF6CC` | Bubabu palette lock. Warm, kid-safe. |
...
| **L4 headline** | «მალე.» - chunky bold rounded, deep cyan `#1A8BBC` | Single word, scannable in 0.3 sec. Cyan ties to Bubabu's goggles (brand recall). |
| **L5 burst sticker** | (none - banned per Bubabu override) | Bursts read tabloid. Sunburst rays carry energy. |
| **L0.5 brand-bar** | Small «bubabu» bottom in soft gold | Lightweight brand anchor, never compete with hero. |
| **Atmosphere** | Candy confetti scattered | Pixar candy-pop kids-commercial feel. |

---
წყარო: agents/bubabu/draft/20260528_thu_teaser_storeroom_reveal/cover.md
აგენტი: lang
თარიღი: 2026-05-28
