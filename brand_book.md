...
## Mission
Создать безопасную, увлекательную и развивающую AI-среду для детей, объединяющую обучение и развлечение без экранов.
...
- Реальный AI разговор (не записанные ответы)
- Без экрана
- Multi-language поддержка
- Ребёнок-безопасный AI
...
- Вопросы перед покупкой:
  1. Сколько стоит? (главный фактор)
  2. Что умеет?
  3. Безопасно ли?
...
### Tone (3 слова)
თბილი / მეგობრული / ჭკვიანი
(тёплый / дружелюбный / умный)
...
- **Patriotic anchor:** Bubabu идентифицирует себя как грузин/грузинку. На английском говорит "we Brits/Americans", на грузинском "ჩვენ ქართველები". Это локализация, не ограничение.

## Visual Identity

### Bubabu Character
- **Body:** ROUND fluffy ball-shape, pure white snowy fur
- **Signature:** Cyan-turquoise goggle eye-markings (aviator-pilot) with cream-beige inner ring
- **Eyes:** Large round black with white highlights
- **Beak:** Small black triangle (STAYS CLOSED in animations)
- **Yellow eyelid arcs** inside cyan goggles
- **Wings:** Small caramel-brown stubby
...
| Black eyes/beak | `#1A1A1A` |
| Caramel wings/feet | `#A47551` |
| Orange toes | `#E8843D` |

### Применение
- **Сайт BUBABU.GE:** primary Warm Teal header, Cream BG, Warm Orange для "Купить"
- **Продающие посты:** Orange CTA на Cream BG, Teal заголовки
- **Образовательные посты:** Soft Yellow badge + Teal text
- **Stand banners:** Teal background + Yellow accents + Cyan goggle highlight
- **Email:** Teal accents + Cream BG + Orange CTA

## Sales Channels
- **Online:** BUBABU.GE
- **Physical:** Tbilisi Mall, Galleria Tbilisi

## Goals (Q2 2026)

### 3 months
- 250 sales/month
- 50+ online via BUBABU.GE
- FB 6,000+ followers
- TikTok 5,000+ followers
- 1 viral video (50K+ views)
...
### Strengths
- 0 Georgian competitors
- UGC of kids reactions already exists (gold)
...
- Brand book incomplete
- No real customer story cases yet
- Seasonality unknown (4 months experience)
- Weekly filming "depends on cost/topic"

### Opportunities
- Cartoon series (Bubabu IP)
- Expat market (EN/RU content)
- Schools (B2B education channel)
- Grandparent gift segment
...
- **Канал:** in-app или email

### 🟢 ОТЛОЖЕНО НА МЕСЯЦ 2 (после первой волны продаж)
- Мульт серии (3 формата A/B/C)
- Маскот mouth + bigger beak update
- Bubabuji.ge marketplace позиционирование

## Pricing Test (planned by Archil)
- Текущая цена: 360 GEL
- Тест-сценарий: 30% cashback (~260 GEL) на выходные → проверка эластичности спроса
- Метрика: если объём вырастает ≥2× → можно постоянно дропнуть цену
...
- Mascot baseline: `agents/mascot/content/20260424_bubabu/`
